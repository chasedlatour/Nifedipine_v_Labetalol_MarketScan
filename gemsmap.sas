...
%macro gemsmap(condition,codetype);
     ...
     *COMBINED FORWARD-BACKWARD MAPPING;
           data &condition._&codetype._fbm_1;
                ...
                proc sql;
                      ...
                      proc sort data = &condition._&codetype._fbm_3 out = &condition._&codetype._fbm_4 nodup;
                           ...
                           run;
                           data &condition._&codetype._fbm_final; /* projlib.&condition._&codetype._fbm_final;*/
     ...
     proc sql; select distinct icd10&codetype from &condition._&codetype._fbm_final /* projlib.&condition._&codetype._fbm_final*/; quit; run; quit; run;
