...
%setup(sample=full, programname=10_sens_dt_lmp, savelog=Y);
...
%count_missing_zero(inds1=ana.dtlmp_boot_1, inds2=ana.dtlmp_boot_2);
%count_missing_zero(inds1=ana.dtlmp_boot_ptb_1, inds2=ana.dtlmp_boot_ptb_2);
