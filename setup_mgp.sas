...
%macro setup_mgp(sample, ProgramName, saveLog=N, serverSpace=local);
...
/*		%ELSE %DO;*/
	      ...
	      libname temp "&ProjDir./data/&sample./temp/mgp"; 
	      libname ana "&ProjDir./data/&sample./analysis/mgp"; 
/*		%END;*/
      ...
      /* Output Paths */
      %LET OutPath = &ProjDir./output/&sample./mgp; 
      ods listing gpath= "&OutPath./graphics/mgp";
