...
%setup(sample=full, programname=13_sens_lmp_plus3w, savelog=Y);
...
%count_missing_zero(inds1=ana.lmpp21_boot_1, inds2=ana.lmpp21_boot_2);
%count_missing_zero(inds1=ana.lmpp21_boot_ptb_1, inds2=ana.lmpp21_boot_ptb_2);
