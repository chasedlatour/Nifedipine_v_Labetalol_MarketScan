/********************************************************************************************************************************************
PROGRAM: 12_sens_chtn.sas
PROGRAMMER: Chase Latour
PURPOSE: The purpose of this program is to run the sensitivity analysis where we restrict to individuals with a chronic hypertension
diagnosis code.
...
%repeat_in_subset(
	...
	sens=chtn,
	where=chronichypertension_pre = 1,
	numboot=1000
);

%count_missing_zero(inds1=ana.chtn_boot_1, inds2=ana.chtn_boot_2);
%count_missing_zero(inds1=ana.chtn_boot_ptb_1, inds2=ana.chtn_boot_ptb_2);
