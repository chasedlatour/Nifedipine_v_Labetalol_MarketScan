...
%setup(sample=full, programname=25_primary_more_cov_ptb, savelog=Y);
...
%competing3risk_weights(
	...
	numiterations=1,
	initialseed=23244, 
	outds=ana.moreadj_point_ptb,
	outds_dist=ga_dist_moreadj_point_ptb,
	outds_ps = NA,
	outds_surv = NA
	);
...
%combine_point_estimates(
	gadist = ana.ga_dist_moreadj_point_ptb,
	numgastrat = 2,
	est = ana.moreadj_point_ptb_,
	outds = ana.moreadj_point_ptb_overall
	);
...
%competing3risk_weights(
	...
	numiterations=1000,
	initialseed=23244, 
	outds=ana.moreadj_boot_ptb,
	outds_dist=ga_dist_moreadj_boot_ptb,
	outds_ps = ps_moreadj_boot_ptb,
	outds_surv = NA
	);
...
%combine_boot_estimates(
			inputEst= ana.moreadj_boot_ptb,
			inputDist= ana.ga_dist_moreadj_boot_ptb,
			numStrata= 2, 
			output_stratified= ana.moreadj_ptb_boot_strat,
			output_overall= ana.moreadj_ptb_boot_overall);

*Stratified estimates with confidence intervals.;
%strat_estimates_w_CI(bootdsn=ana.moreadj_boot_ptb_1, pointdsn=ana.moreadj_point_ptb_1, output=ana.moreadj_boot_ptb_1_ci);
%strat_estimates_w_CI(bootdsn=ana.moreadj_boot_ptb_2, pointdsn=ana.moreadj_point_ptb_2, output=ana.moreadj_boot_ptb_2_ci);

*OVerall estimates with confidence interval;
%overall_estimates_w_CI(stderrdsn=ana.moreadj_ptb_boot_overall, pointdsn=ana.moreadj_point_ptb_overall, output=ana.moreadj_overall_ptb_boot_ci);

	
%count_missing_zero(inds1=ana.moreadj_boot_ptb_1, inds2=ana.moreadj_boot_ptb_2);
